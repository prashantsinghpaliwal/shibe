...
/**
 * @url: https://github.com/android/architecture-components-samples/blob/a4c17b2a1ea86b113edd5c82cc3abc4205a02c91/PagingWithNetworkSample/app/src/main/java/android/arch/paging/PagingRequestHelper.java
 *
 * There might be some changes to the online version
 *
 * */
package com.prashant.shibe.utils;
...
public class PagingRequestHelper {
    ...
    public enum RequestType {
        /**
         * Corresponds to an initial request made to a {@l ink DataSource} or the empty state for
